...
app = Flask(__name__,template_folder="C:/xampp/htdocs/AirportAnalysiss-main/practice/templates")
...
def get_delay():
    if request.method=='POST':
        ...
        bat_vector = np.zeros(len(index_dict))
        cat_vector = bat_vector.reshape(1,-1)
